...
public class StockAdd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addQuantity=findViewById(R.id.etQuanty);
        btnUpdate=findViewById(R.id.btnAddStock);
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            for(DataSnapshot stockSnapshot:dataSnapshot.getChildren()){
                                ...
                                if(id==Integer.valueOf(String.valueOf(itemId.getText()))){
                                    ...
                                    tmp=1;
                                    showSuccess();
                                    Intent intent=new Intent(StockAdd.this, DashboardFragment.class);
                                    intent.putExtra("CALLINGACTIVITY","StockAdd");
