...
public class StaffLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stfname = (EditText) findViewById(R.id.etUsername);
        stfpass = (EditText) findViewById(R.id.etPass);
        stfstatus = (TextView) findViewById(R.id.tvStat);
        stflogin = (Button) findViewById(R.id.btnLogin2);
        stfstatus.setText("");
        stflogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(sna))
                    ...
                    StaffAdd.databaseStaff.addValueEventListener(new ValueEventListener() {
                        @Override
